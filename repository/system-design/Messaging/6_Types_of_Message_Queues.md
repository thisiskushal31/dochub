...
- **Event streaming** — When you need high throughput, replay, and multiple consumer groups reading the same log. See [Queues vs streams](4_Queues_vs_Streams.md).
