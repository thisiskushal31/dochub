...
**Use case:** Any pipeline or queue where producers can be faster than consumers. Combine with retries and circuit breakers so clients know when to back off. See [Message queues](1_Message_Queues.md) and [Availability — Background jobs](../Availability/5_Background_Jobs.md).
