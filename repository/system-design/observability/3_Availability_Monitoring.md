...
**Use case:** Report on SLOs, error budgets, and incident impact. Combine with [Health monitoring](2_Health_Monitoring.md) (current state) and [Performance monitoring](4_Performance_Monitoring.md) (how well it ran when up).
