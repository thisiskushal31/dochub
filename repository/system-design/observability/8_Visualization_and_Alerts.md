...
**Use case:** Runbooks and dashboards should be next to alerts so that when something fires, the team can quickly understand and act. Combine with [Instrumentation](7_Instrumentation.md) so the data behind the dashboard is complete and accurate.
