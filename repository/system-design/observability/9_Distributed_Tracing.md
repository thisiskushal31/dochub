...
**When to use:** Use in **microservices** and **multi-tier** systems to understand request flow and latency. Combine with metrics and logs (trace id in logs). See [Instrumentation](7_Instrumentation.md) and [Monitoring overview](1_Monitoring_Overview.md).
