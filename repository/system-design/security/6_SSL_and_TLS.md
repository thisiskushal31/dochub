...
**When to use:** Use **TLS for all** external and sensitive traffic; use **mTLS** where you need strong service identity and encryption between services. See [Security overview](1_Security_Overview.md).
