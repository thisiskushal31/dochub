...
**When to use:** Use edge caching (e.g. via CDN) for static assets and for dynamic content that can tolerate edge TTLs. See [CDN](../Fundamentals/4_CDN.md) and [Cache layers](6_Cache_Layers.md).
