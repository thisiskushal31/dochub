...
**When to use:** Choose based on workload: LRU for general caches; TTL when data has a natural expiry; LFU when frequency is a better predictor than recency. See [Caching overview](1_Caching_Overview.md) and [Cache layers](6_Cache_Layers.md).
