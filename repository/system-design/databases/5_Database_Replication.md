...
![Master-slave replication: primary and replicas](../Assets/Databases/Master_Slave_Replication.png)
...
**Previous**: [Database Sharding](4_Database_Sharding.md) | **Next**: [CAP Theorem](6_CAP_Theorem.md)
