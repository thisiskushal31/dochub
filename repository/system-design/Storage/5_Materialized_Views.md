...
Use materialized views when you have **read-heavy**, **complex** queries (joins, aggregates) and can tolerate **eventual freshness**. Combine with [Denormalization](../Databases/10_Denormalization.md) and [CQRS](../Patterns/2_Cqrs.md) (read models) for event-driven or reporting workloads. See [Indexing](1_Indexing.md) and [OLTP vs OLAP](4_OLTP_vs_OLAP.md).
