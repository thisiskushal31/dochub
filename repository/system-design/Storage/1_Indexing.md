...
**Use case:** Add indexes for hot query patterns; avoid over-indexing write-heavy tables. See also [Partitioning](2_Partitioning.md) and [OLTP vs OLAP](4_OLTP_vs_OLAP.md).
