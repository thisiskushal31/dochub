...
**Use case:** Large tables or datasets that outgrow a single node; read/write scaling and isolation. See [Databases — Sharding](../Databases/4_Database_Sharding.md) for more.
