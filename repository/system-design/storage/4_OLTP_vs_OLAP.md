...
**Use case:** Use OLTP for the system of record and real-time APIs; replicate or ETL into an OLAP store for analytics so heavy queries don’t impact transactions. See [Partitioning](2_Partitioning.md) and [Indexing](1_Indexing.md) for tuning each.
