...
**When to use:** Start with a **monolith** when the domain is unclear or the team is small; consider **microservices** when you need independent scaling, multiple teams, or clear bounded contexts. See [Microservices](8_Microservices.md) for more.
