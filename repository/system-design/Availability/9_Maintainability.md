...
- **Modularity** — Clear boundaries between components; change one part without breaking others. See [Microservices](../Fundamentals/8_Microservices.md).
- **Observability** — Logs, metrics, traces so you can understand behavior and debug. See [Observability](../Observability/1_Monitoring_Overview.md).
