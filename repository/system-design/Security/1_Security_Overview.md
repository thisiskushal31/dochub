...
**Use case:** Design auth and authz early; encrypt sensitive data; isolate components and tenants; monitor and respond to security events. See [Federated identity](2_Federated_Identity.md), [Gatekeeper](3_Gatekeeper.md), and [Valet key](4_Valet_Key.md).
