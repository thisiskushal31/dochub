...
**Use case:** Review designs and code for these patterns; fix hot paths first. See [Rate limiting](2_Rate_Limiting.md) for protecting APIs and [Caching](../Caching/README.md) for reducing load.
