...
- **Availability** — With minority failures, the system can still progress; with partition or majority down, progress may block (CP in CAP). See [CAP theorem](2_CAP_Theorem.md).
...
**When to use:** When you need **replicated, consistent** state or **leader election** across nodes that can fail. See [Leader election](../Patterns/3_Leader_Election.md) and [Replication](../Availability/3_Replication.md).
