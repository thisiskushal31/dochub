...
**Use case:** Add instrumentation early; include trace ids in logs so you can jump from metric to trace to log. See [Visualization and alerts](8_Visualization_and_Alerts.md) for consuming this data.
