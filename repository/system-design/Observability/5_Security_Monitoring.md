...
**Use case:** Any system with authentication or sensitive data. Combine with [Security — Overview](../Security/1_Security_Overview.md) and general [Monitoring](1_Monitoring_Overview.md). Ensure monitoring itself is secured (access control, integrity of logs).
