...
![Load balancer distributing requests across backends](../Assets/Fundamentals/Load_Balancer.png)
...
- **Multi-datacenter** — LBs route traffic to the nearest or healthiest region; see [Failover](../Availability/2_Failover.md) and active-active setups.
