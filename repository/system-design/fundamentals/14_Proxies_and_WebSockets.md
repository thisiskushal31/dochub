...
![Forward proxy: clients → proxy → internet](../Assets/Fundamentals/Forward_Proxy.png)  
![Reverse proxy: clients → proxy → your servers](../Assets/Fundamentals/Reverse_Proxy.png)
