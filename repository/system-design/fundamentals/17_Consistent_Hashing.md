...
**When to use:** Whenever you distribute data or load across a set of nodes that may grow or shrink (caches, shards, CDN). See [Partitioning](../Storage/2_Partitioning.md) for rebalancing in storage systems.
