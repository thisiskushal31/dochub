...
![Logging, tracing, and metrics — three pillars of observability (ByteByteGo)](../Assets/Observability/Bytebytego_Logging_Tracing_Metrics.png)
...
![Latency numbers — from L1 cache to network RTT (ByteByteGo)](../Assets/Observability/Bytebytego_Latency_Numbers.jpg)
