...
[← Back to Monitoring & observability](../README.md) · [Metric types](../6_Metric_Types_And_Aggregation.md) · [Grafana](../Grafana/README.md) · [Tool kinds](../27_Tool_Kinds_By_Job.md)
...
| **Cardinality** | Bound labels; avoid user/request IDs ([7](../7_Cardinality_And_Label_Contracts.md)) |
