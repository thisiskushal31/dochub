...
- [Matching juice products](#matching-juice-products)
- [Match juice products, but deprioritize apple juice](#match-juice-products-but-deprioritize-apple-juice)
- [Without filtering (deprioritize everything apples)](#without-filtering-deprioritize-everything-apples)
- [More examples](#more-examples)
  - ["I like pasta"](#i-like-pasta)
  - ["I don't like bacon"](#i-dont-like-bacon)
  - [Pasta products, preferably without bacon](#pasta-products-preferably-without-bacon)
  - ["I like pasta, but not bacon"](#i-like-pasta-but-not-bacon)
  - [Disjunction max (`dis_max`)](#disjunction-max-dis_max)
- [Basic usage](#basic-usage)
- [Specifying a tie breaker](#specifying-a-tie-breaker)
  - [Introduction to relevance scoring](#introduction-to-relevance-scoring)
  - [Nested inner hits](#nested-inner-hits)
- [Enabling inner hits](#enabling-inner-hits)
- [Specifying custom key and/or number of inner hits](#specifying-custom-key-andor-number-of-inner-hits)
  - [Phrase searches](#phrase-searches)
- [Basic usage](#basic-usage)
- [More examples](#more-examples)
  - [Prefixes, wildcards & regular expressions](#prefixes-wildcards-regular-expressions)
- [Searching for a prefix](#searching-for-a-prefix)
- [Wildcards](#wildcards)
  - [Single character wildcard (`?`)](#single-character-wildcard-)
  - [Zero or more characters wildcard (`*`)](#zero-or-more-characters-wildcard-)
- [Regexp](#regexp)
- [Case insensitive searches](#case-insensitive-searches)
  - [Querying by field existence](#querying-by-field-existence)
- [Basic usage](#basic-usage)
- [Inverting the query](#inverting-the-query)
  - [Querying nested objects](#querying-nested-objects)
- [Importing test data](#importing-test-data)
- [Searching arrays of objects (the wrong way)](#searching-arrays-of-objects-the-wrong-way)
- [Create the correct mapping (using the `nested` data type)](#create-the-correct-mapping-using-the-nested-data-type)
- [Using the `nested` query](#using-the-nested-query)
...
- [Basic usage](#basic-usage)
- [Querying dates](#querying-dates)
  - [Basic usage](#basic-usage)
  - [Specifying the time](#specifying-the-time)
  - [Specifying a UTC offset](#specifying-a-utc-offset)
  - [Specifying a date format](#specifying-a-date-format)
...
- [Searching for booleans](#searching-for-booleans)
- [Searching for numbers](#searching-for-numbers)
- [Searching for dates](#searching-for-dates)
- [Searching for timestamps](#searching-for-timestamps)
  - [Searching multiple fields](#searching-multiple-fields)
- [Basic usage](#basic-usage)
- [Per-field relevance boosting](#per-field-relevance-boosting)
- [Specifying a tie breaker](#specifying-a-tie-breaker)
  - [The match query](#the-match-query)
- [Basic usage](#basic-usage)
- [Searching for multiple terms](#searching-for-multiple-terms)
- [Specifying the operator](#specifying-the-operator)
