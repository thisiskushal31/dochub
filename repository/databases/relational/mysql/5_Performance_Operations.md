...
**Previous**: [MySQL Transactions & Concurrency](./4_Transactions_Concurrency.md)

**Next**: [MySQL Security & Maintenance](./6_Security_Maintenance.md) | [Back to MySQL Deep Dive](../README.md)