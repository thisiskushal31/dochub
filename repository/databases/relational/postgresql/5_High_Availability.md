...
![Patroni Cluster Components](../Assets/PostgreSQL/Patroni_Components.png)
...
![Patroni Healthy Cluster](../Assets/PostgreSQL/Patroni_Leader_Lock.png)
...
![Patroni Impaired Cluster](../Assets/PostgreSQL/Patroni_Impaired_Cluster.png)
...
![Patroni WAL Log Positions](../Assets/PostgreSQL/Patroni_Wal_Log_Positions.png)
...
![Patroni Leader Race](../Assets/PostgreSQL/Patroni_Leader_Race.png)
...
![Patroni Type A Architecture](../Assets/PostgreSQL/Patroni_Type_a.png)
...
![Patroni Type B Architecture](../Assets/PostgreSQL/Patroni_Type_B.png)
...
![Patroni Type C Architecture](../Assets/PostgreSQL/Patroni_Type_C.png)
...
![Load Balancing Configuration](../Assets/PostgreSQL/Load_Balancing.jpg)
...
![pg_auto_failover Architecture](../Assets/PostgreSQL/Pg_Auto_Failover_Architecture.png)
...
![pg_auto_failover Failure Scenarios](../Assets/PostgreSQL/Pg_Auto_Failover_Failure_Scenarios.png)
...
![Stateful MIG with Regional Persistent Disk](../Assets/PostgreSQL/Stateful_Mig_Regional_Pd.svg)
...
![Zonal Failure Replacement](../Assets/PostgreSQL/Zonal_Failure_Replacement.svg)
...
**Previous**: [PostgreSQL Transactions & Concurrency](./4_Transactions_Concurrency.md)

**Next**: [PostgreSQL Performance & Operations](./6_Performance_Operations.md) | [Back to PostgreSQL Deep Dive](../README.md)