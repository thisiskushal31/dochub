...
![DBMS 1-Tier Architecture](../../Assets/DBMS-Fundamentals/Dbms_1_Tier_Architecture.webp)

*Image Source: [DBMS Architecture - GeeksforGeeks](https://www.geeksforgeeks.org/dbms/dbms-architecture-2-level-3-level/)*

![DBMS 2-Tier Architecture](../../Assets/DBMS-Fundamentals/Dbms_2_Tier_Architecture.webp)

*Image Source: [DBMS Architecture - GeeksforGeeks](https://www.geeksforgeeks.org/dbms/dbms-architecture-2-level-3-level/)*

![DBMS 3-Tier Architecture](../../Assets/DBMS-Fundamentals/Dbms_3_Tier_Architecture.webp)
...
- **[ER & Relational Model](./2_ER_Relational_Model.md)**: Entity-Relationship modeling and relational database concepts
- **[Relational Algebra](./3_Relational_Algebra.md)**: Query operations and joins
- **[Transactions & Concurrency Control](./5_Transactions_Concurrency_Control.md)**: ACID properties and transaction management
