...
![Normal Forms Hierarchy](../../Assets/DBMS-Fundamentals/Normalization_Venn_Diagram.webp)
...
- **[ER & Relational Model](./2_ER_Relational_Model.md)**: Database design principles
- **[Transactions & Concurrency Control](./5_Transactions_Concurrency_Control.md)**: ACID properties
- **[Advanced DBMS](./6_Advanced_DBMS.md)**: Indexing strategies
