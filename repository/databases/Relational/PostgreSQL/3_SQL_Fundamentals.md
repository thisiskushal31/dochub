...
**Previous**: [PostgreSQL Data Management](./2_Data_Management.md)

**Next**: [PostgreSQL Transactions & Concurrency](./4_Transactions_Concurrency.md) | [Back to PostgreSQL Deep Dive](../README.md)